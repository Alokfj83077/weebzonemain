                ...
                if download.message.chat.type != 'private':
                    try:
                        ...
                        if EMOJI_THEME is True:
                            ...
                            msg += f'\n<b>Adder: </b><a href="https://t.me/c/{chatid}/{download.message.message_id}">{download.message.from_user.first_name}</a> </b> <code>({download.message.from_user.id})</code>'
